...
const CardDotedMobile = ({ item }) => {
  ...
  return (
    <div
      key={item.id}
      className={`bg-[#F5F5F7] border rounded-lg shadow-md p-4 w-[300px] xs:w-[190px] sm:w-[240px]  font-montserrat relative`}
    >
      {/* Heart Icon */}
...
export default CardDotedMobile;
