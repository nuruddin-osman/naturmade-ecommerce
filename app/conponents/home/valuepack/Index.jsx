...
const ValuePack = () => {
  ...
  return (
    <div className="bg-[#F5F5F7]">
      <div className="container mx-auto py-20 flex flex-col md:flex-row gap-8 justify-between px-3">
        ...
        <div className="w-full md:w-1/2">
          <div className="">
            ...
            <p className="text-sm lg:text-lg font-lato font-normal leading-normal text-[#343438] mb-5">
              {data?.description}
            </p>
