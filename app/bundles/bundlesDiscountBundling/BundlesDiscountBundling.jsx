  ...
  return (
    <div className="bg-[#F5F5F7] py-8 md:py-16">
      <div className="container mx-auto p-5">
        ...
        <Heading
          className="!text-left"
          title="Understanding Discount Bundling"
        />
        <SubHeading
          className="!text-left"
          title="Nature Made® value packs bundle products into one convenient shipment at a discount.†"
        />
...
export default BundlesDiscountBundling;
